...
mj = joblib.load("./ai_traffic_system/model_new2joblib") 
...
def ml_model_timer(flow):
    ...
    elif green_time_predict >3 and green_time_predict < 10:
        green_time_predict=5
    elif green_time_predict > 10:
        green_time_predict = 9
...
speeds = {'car':2.0, 'bus':1.8, 'truck':1.8, 'bike':2.1, 'ambulance':2.0}
...
signalTimerCoods = [(450, 480), (700, 200), (1020, 355), (700, 580)]
...
#     count=0
#     while True:
#         vehicle_type =allowedVehicleTypesList[4]
